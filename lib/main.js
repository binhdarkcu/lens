...
//    });
 ...
 document.getElementById('html').onclick = function(e) {
    if(e.target != hLenValue && e.target.className != 'slider-track' && e.target.className != 'slider-handle min-slider-handle round') {
          
          hLenValue.value =  oldHLenValue;
    }
    if(e.target != valueofA && e.target.className != 'slider-track' && e.target.className != 'slider-handle min-slider-handle round') {
          
          valueofA.value =  oldValueofA;
    } 
    if(e.target != valueofF && e.target.className != 'slider-track' && e.target.className != 'slider-handle min-slider-handle round') {
