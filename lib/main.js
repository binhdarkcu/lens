$(function() {
  ...
  function makeLend(heightLen,Widthlen){
    ...
    var angleStart  = getCenterLine() - (( dCanDefault - halfWCan ) * rDCan);
    var angleStart2 =  getCenterLine() + (( dCanDefault - halfWCan ) * rDCan);
    var widthF = 20; var heightF = 30;
    var f1Left = getCenterLine() - Math.round(( (fDefaultValue - (widthF/2)) * rDCan));
    var f2Left = getCenterLine() + Math.round(( (fDefaultValue - (widthF/2)) * rDCan));
    ...
    console.log(heightLine - (HCanDefault * rHCan ));
    console.log(HCanDefault * rHCan);
...
fControlb.onchange = function(){
 ...
 function resetCavas(){
  ...
  function setWhenChangeA(hChange,fchanged,dChanged){
     ...
     var leftCanFalse = getCenterLine() + getDCanFalse() - cFalse.getWidth()/2;
    ...
    if(parseInt(dChanged) <= parseInt(fchanged)){
        ...
        //if(parseInt(getHeightCanFalse()) < -100){
    ...
    if(getHeightCanFalse() <= 50 && getHeightCanFalse() >1){
        cFalse.setWidth(widthCan);
     }
    cTrue.setLeft(getCenterLine() - dChanged - cTrue.getWidth()/2);
  ...
  function changeDCan(d){
      cTrue.setLeft(getCenterLine() - getDCanTrue() - cTrue.getWidth()/2);
      cFalse.setLeft(getCenterLine() + getDCanFalse() - cTrue.getWidth()/2);
      cFalse.setHeight(getHeightCanFalse());
  }
